...
== %DORN_JOINED% @1 /* You speak of me, paladin? Of course you do. I wonder, is it rage or fear that makes your voice shake so? */
...
== %DORN_JOINED% @5 /* You would keep such a simpering fool in your party, <CHARNAME>? Do not think that I will endure this one's sanctimonious nonsense any longer. */
END
	++ @6 /* Whoa! Is this really necessary? */ EXTERN %DORN_JOINED% rh#dorn2
	++ @7 /* Very well. You brought this upon yourself, Isra. */ EXTERN RH#ISRAJ rh#dorn3
	++ @8 /* I have had enough of your vileness anyway, Dorn. */ EXTERN %DORN_JOINED% rh#dorn4

CHAIN %DORN_JOINED% rh#dorn2
...
== %NEERA_BANTER% @15 /* Oh! Well, I was thinking about altering the cut of this robe a bit. Though I'd probably just wreck it. I don't know that much about sewing. */
== BRH#ISRA @16 /* Can you alter a mage's robe at all without risking its power? */
== %NEERA_BANTER% @17 /* I, um, actually don't know. I guess we can try it and find out, right? */
...
== %NEERA_BANTER% @20 /* I'm sorry. If it has special religious meaning or something, I wouldn't want to cause offense. */
== BRH#ISRA @21 /* You haven't, no, but it isn't exactly the sort of thing I would wear in public. */
== %NEERA_BANTER% @22 /* I don't see why not. It looked pretty amazing. */
...
== %NEERA_BANTER% @25 /* Right. Well, it was really just a thought. I mean, it'd be just great if I went and ruined it and then had nothing at all to wear. */
= @26 /* Yeah, now you're definitely blushing. */
== BRH#ISRA @27 /* ... You really are too much sometimes, Neera. */
== %NEERA_BANTER% @28 /* Oh, I know it. */
EXIT
...
CombatCounter(0)
!See([ENEMY])
Global("rh#IsraNeera2","GLOBAL",0)~ THEN %NEERA_BANTER% rh#IsraNeera2
...
== %NEERA_BANTER% @32 /* I don't! But, well, you're from Amn, and everyone knows how the Amnish feel about magic, and my type... yeah. */
...
== %NEERA_BANTER% @35 /* I didn't think you would be. And some of the things I've done with it... accidentally, of course, and not nearly as often as everyone seems to think, but-- */
= @36 /* You're not honor bound to smite me or something if I tell you about this stuff, are you? */
== BRH#ISRA @37 /* No, of course not. */
== %NEERA_BANTER% @38 /* Good. Though I'm not really sure why I'm talking to you about this at all. I mean, I don't suppose guilt is a feeling you'd have much experience with. The slightest mistake, and POOF, no more paladinhood, right? */
...
== %NEERA_BANTER% @40 /* That's reassuring, but when your failings are kind of outside of your control... I don't know. It's not something I can just... fix. */
...
== %NEERA_BANTER% @42 /* That might actually be a good idea. You don't happen to know any Mystrans, do you? */
== BRH#ISRA @43 /* There are precious few in Amn, I'm afraid. */
== %NEERA_BANTER% @44 /* Well, I guess it can wait. I've figured stuff out well enough on my own so far. Sort of. A bit longer shouldn't make much of a difference. */
EXIT
...
== %RASAAD_BANTER% @46 /* You are familiar with-- no, of course you would be familiar with Selûne's faithful. */
...
== %RASAAD_BANTER% @49 /* Truth is universal; interpretation is the reflection by which we might come to understand it. I would be very interested in speaking with such mystics. */
...
== %RASAAD_BANTER% @52 /* That is unfortunate. I have heard that there are several Sunite Sun Soul sects in Amn. */
== BRH#ISRA @53 /* I wonder if their teachings would be as unfamiliar to me as yours are. 'Tis a most... unsettling thought, truly. */
== %RASAAD_BANTER% @54 /* Unsettling? I am surprised that you would not welcome the prospect. Perhaps one can never understand all that there is to know about one's own faith, but the journey is often as important as the destination. */
...
== %RASAAD_BANTER% @57 /* Deeper? I do not think so. Your goddess is a being of passion, yes? There are aspects of her nature that no monk, no matter how learned, could grasp. */
...
CombatCounter(0)
!See([ENEMY])
Global("rh#IsraRasaad2","GLOBAL",0)~ THEN %RASAAD_BANTER% rh#IsraRasaad2
...
== %RASAAD_BANTER% @62 /* Food was... not a priority at the time. */
== BRH#ISRA @63 /* No... no, I imagine not. */
== %RASAAD_BANTER% @64 /* But yours is very good, Isra. It is not a skill I would have thought to associate with a paladin. */
...
== %RASAAD_BANTER% @66 /* Initiates of the monastery perform such chores as well, though it is a task reserved for the youngest of novices, in order to teach them the value of discipline and patience. */
...
== %RASAAD_BANTER% @68 /* It is interesting to me how similar and yet how different our experiences have been. Perhaps that is not surprising. The slightest shift of the mirror's angle causes the light to reflect in new and often unexpected ways. */
== BRH#ISRA @69 /* And 'tis those very differences that remind us that we are none of us alone in this world. */
== %RASAAD_BANTER% @70 /* Indeed. I thank you for this discussion, my friend. I appreciate all opportunities to further my learning, not least those that were unanticipated. */
EXIT